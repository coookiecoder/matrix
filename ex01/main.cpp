...
auto main() -> int {
    Vector vector_test_a(3, {1, 2, 3});
    Vector vector_test_b(3, {0, 10, -100});

    Vector result = linear_combination({vector_test_a, vector_test_b}, {10, -2});
    ...
    Vector vector_error_a(3, {1, 2, 3});
    Vector vector_error_b(4, {0, 10, -100});
